...
include_graphics(path = "MFMRlogoNew.png")
```
...
*Alexandrium sp.* cell abundance at Aquapark 4 was measued above the alert threshold this week. Growers are advised to take caution when harvesting due to increased risk of PST accumulation. 
