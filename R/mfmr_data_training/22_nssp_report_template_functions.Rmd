...
```{r include = FALSE}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, fig.id="pressure", fig.width=8)
```
...
include_graphics(path = "data/namibia_coat_smaller.jpg")
```
...
years <- unique(x$year)
myColors <- brewer.pal(length(years),"Set1")
...
```{r fig.cap="PST tests in Oysters at Aquapark 1 Red line represents the Codex limit."}
